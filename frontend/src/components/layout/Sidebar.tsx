...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { href: '/settings/branches', label: 'Filiallar', icon: Building2 },
    { href: '/settings/billing', label: t('billing') || 'Billing', icon: CreditCard },
    { href: '/settings/security', label: 'Xavfsizlik', icon: Lock },
    { href: '/super-admin', label: 'Super-Admin', icon: Crown },
    { href: '/settings/design-system', label: 'UI Guidelines', icon: Palette },
  ];
